...
def create_l1_topology():
    ...
    L1_INPUT = './documentation/DC1_FABRIC/DC1_FABRIC-p2p-links.csv'
    ...
    headers = 'type, Leaf Node,Leaf Interface,Leaf IP Address,Port-Channel,Peer Node,Peer Interface,Peer IP Address,Port-Channel'
    ...
    for index, row in df.iterrows():
        ...
        new_edge['node1']['hostname'] = row[' Leaf Node'].lower()
        new_edge['node1']['interfaceName'] = row['Leaf Interface']
        new_edge['node2']['hostname'] = row['Peer Node'].lower()
